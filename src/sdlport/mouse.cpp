...
unsigned char def_mouse[] = {0, 2, 0, 0, 0, 0, 0, 0, 2, 1, 2, 0, 0, 0, 0, 0,
                             2, 1, 1, 2, 0, 0, 0, 0, 2, 1, 1, 1, 2, 0, 0, 0,
                             2, 1, 1, 1, 1, 2, 0, 0, 2, 1, 1, 1, 1, 1, 2, 0,
                             0, 2, 1, 1, 2, 2, 0, 0, 0, 0, 2, 1, 1, 2, 0, 0,
                             0, 0, 2, 1, 1, 2, 0, 0, 0, 0, 0, 2, 2, 0, 0, 0};
...
void JCMouse::set_position(int new_mx, int new_my) {
  ...
  SDL_WarpMouseInWindow(sdl_window, new_mx, new_my);
}
